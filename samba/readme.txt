...
问题解决:
   有时 samba server 端 修改了 samba user account 的 密码, 但 windows 操作系统的客户端可能无法正常工作,
   此时 在 windows 上清理 一些 与 samba 相关的缓存 即可:
        ...
        C:\Users\DELL>net use
                ...
                -------------------------------------------------------------------------------
                OK                     \\192.168.175.10\IPC$     Microsoft Windows Network
                命令成功完成。

        C:\Users\DELL>net use \\192.168.175.10\IPC$
                本地名称
                远程名称     \\192.168.175.10\IPC$
                资源类型     IPC
                状态         OK
                # 打开       0
                # 连接       1
        ...
        C:\Users\DELL>net use \\192.168.175.10\IPC$ /del
                \\192.168.175.10\IPC$ 已经删除。
